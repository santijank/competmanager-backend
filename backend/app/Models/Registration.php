...
class Registration extends Model
{
    ...
    public function getStudentsAttribute()
    {
        ...
        return collect($this->student_names)->map(function($student, $index) {
            // ถ้าเป็น array with 'name' key
            if (is_array($student) && isset($student['name'])) {
                return (object)[
                    'id' => $index + 1,
                    'name' => $student['name'],
                ];
    ...
    // ✅ NEW: Teachers Attribute (สำหรับ Export)
    public function getTeachersAttribute()
    {
        ...
        return collect($this->teacher_names)->map(function($teacher, $index) {
            // ถ้าเป็น array with 'name' key
            if (is_array($teacher) && isset($teacher['name'])) {
                return (object)[
                    'id' => $index + 1,
                    'name' => $teacher['name'],
                ];
