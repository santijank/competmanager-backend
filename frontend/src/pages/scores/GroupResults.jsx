...
const GroupResults = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const response = await api.get('/scores/group-results');
  ...
  const handleExportPdf = async (competitionId, type = 'all') => {
    try {
      ...
      const response = await api.get(`/scores/group-certificates-pdf/${competitionId}`, {
        params: { type },
        responseType: 'blob'
      });
      ...
      link.href = url;
      link.setAttribute('download', `เกียรติบัตรระดับกลุ่ม_${competitionId}.pdf`);
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">
                  ผลการแข่งขันระดับกลุ่ม
                </h1>
                <p className="text-gray-600 mt-1">
                  สรุปผลการแข่งขันระดับกลุ่มที่ยืนยันแล้ว สำหรับออกเกียรติบัตร
                </p>
              </div>
            </div>
            <button
        ...
        {filteredCategories.length === 0 ? (
          <div className="bg-white rounded-lg border border-gray-200 p-12 text-center">
            ...
            <p className="text-gray-600 text-lg">
              ยังไม่มีผลการแข่งขันระดับกลุ่มที่ยืนยันแล้ว
            </p>
            <p className="text-gray-400 text-sm mt-2">
              ผลจะแสดงเมื่อมีการยืนยันคะแนน (Finalize) ในระดับกลุ่ม
            </p>
          </div>
        ) : (
                              ...
                              <div className="flex items-center space-x-3 flex-1">
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  <div className="flex items-center space-x-2 text-xs text-gray-500">
                                    ...
                                    {comp.school_group_name && (
                                      <>
                                        <span>|</span>
                                        <span>{comp.school_group_name}</span>
                                      </>
                                    )}
                                  </div>
                                </div>
                              ...
                              <div className="flex items-center space-x-3 flex-shrink-0">
                                ...
                                <div className="flex items-center space-x-1">
                                  <button
                                    ...
                                    className="flex items-center px-2 py-1 text-xs border border-green-300 text-green-700 rounded hover:bg-green-50 transition-colors disabled:opacity-50"
                                    title="PDF ทั้งหมด"
                                  >
