...
/**
 * EditJudgeModal Component
 * 
 * Form แก้ไขข้อมูลกรรมการ
 * - ชื่อ-นามสกุล (required)
 * - โรงเรียน/หน่วยงาน (optional)
 */
export default function EditJudgeModal({ isOpen, judge, onClose, onEdit }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Error in EditJudgeModal:', error);
    } finally {
