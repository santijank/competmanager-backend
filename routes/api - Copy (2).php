...
use App\Http\Controllers\Api\JudgeController;  // ✅ เพิ่ม Judge Controller
...
Route::get('/status', [RegistrationSettingsController::class, 'status']);
    ...
    // ✅✅✅ เพิ่มบรรทัดนี้ - สำหรับหน้าใส่คะแนน ✅✅✅
    ...
    Route::middleware('role:admin,district_admin,group_admin')->group(function () {
        ...
        // เพิ่ม routes สำหรับบันทึกคะแนนรายบุคคลและแบบ bulk
...
Route::get('/competitions/{competition}/registrations/export/pdf', 
    [App\Http\Controllers\Api\RegistrationExportController::class, 'exportPdf']);

Route::get('/competitions/{competition}/registrations/export/excel', 
    [App\Http\Controllers\Api\RegistrationExportController::class, 'exportExcel']);

Route::get('/competitions/{competition}/registrations/export/summary', 
    [App\Http\Controllers\Api\RegistrationExportController::class, 'exportSummary']);

Route::get('/competitions/{competition}/registrations/{registration}/export/certificate', 
    [App\Http\Controllers\Api\RegistrationExportController::class, 'exportCertificate']);=========================================
    // 🎓 Certificates
    // ============================================
